...
// std::cout<<"it's over"<<std::endl;
	...
	int t_size;double offset;int Niter;std::string path_to_disparity;int nbmaxThreadPoolThreading;int zoom;std::string method;std::string path_to_initial_disparity;double ratioGap;
